...
//    qDebug() << "try -2 U_1_plus + U_2_plus + U_3_plus > " << bad_advice_3 << " for more fun result" << '\n';
    ...
    ui->PlotWidget_P->replot();ui->PlotWidget_P->savePdf("../custom-omni-wheel-vehicle-control/PICS/power_V_circle.pdf");
    ...
    ui->PlotWidget_PT->xAxis->setRange(0, t_symm.last());
    ...
    ui->PlotWidget_PT->savePdf("../custom-omni-wheel-vehicle-control/PICS/power_T_circle.pdf");
