...
static std::array<double, 3> compute_N()
{
    double g = 9.81;
    double a_data[] = {1, 1, 1, parameters::symmetrical::delta[0] * cos(parameters::symmetrical::alpha[0]),
    ...
    double b_data[] = {g, 0, parameters::symmetrical::Delta * g};
